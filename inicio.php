...
<body>
    ...
    <header>
       ...
       <!-- <section id="user_options">
            <img src="imagenes/iconos/account-circle.png" alt="" class="iconos" id="logo_user" onclick="set_cerrar();">
            <div id="menu_usuario" class="cerrado">
                <img src="imagenes/iconos/account-circle.png" alt="" class="iconos_2" id="logo_user">
                <hr>
                <div class="flex">
                    <span class="titulos"><?php echo $user;?></span>
                </div>
    ...
    <main>
        ...
        <section id="menu_principal" class="menu_p">
                <div class="flex_centrado_colum" id="">
                    ...
                    <a href="usuarios/actualiza_user_data.php">Actualizar Datos</a>
                </div>
                <hr>
